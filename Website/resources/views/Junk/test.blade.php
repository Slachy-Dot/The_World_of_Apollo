...
<html lang="en">
  ...
  <head>
    ...
    <link href="{{ asset('css/apollo.css') }}" rel="stylesheet">
  ...
  <body style="background-image: url(../Assets/images/main/background.jpg);" class="min-h-screen bg-cover lg:">
    ...
    <nav class="flex justify-center px-4 text-gray-800 bg-transparent">
      <div class="container py-2">
        ...
        <div>
          <a href="/"><img loading=lazy class="my-nav-logo" src="../Assets/images/main/Apollo_logo.png" alt="Logo" /></a>
        </div>
  ...
  <section class="max-w-sm m-auto mt-32 bg-indigo-900 border-2 border-blue-400 border-opacity-75 rounded-lg shadow-2xl carousel md:max-w-xl">
    ...
    <div id="slide2" class="relative w-full carousel-item">
      <img loading=lazy src="../Assets/images/gallery/b/Apollo_b2.jpg" class="w-full">
      <div class="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
